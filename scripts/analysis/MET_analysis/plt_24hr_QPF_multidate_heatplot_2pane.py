...
out_path = data_root + '/' + START_DT + '_' + END_DT + '_lev_' + LEV +\
           '_' + LND_MSK + '_' + stat1 + '_' + stat2 + '_heatplot.png'
...
tmp = np.zeros([num_leads, num_dates, 2])
...
ax1.set_xticklabels(data_dates)
ax1.set_yticklabels(data_leads)
ax2.set_xticklabels(data_dates)
ax2.set_yticklabels(data_leads)
...
title1='24hr accumulated precip at '
