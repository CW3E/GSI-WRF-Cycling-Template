...
#
# This script is designed to work with an eccodes conda environment for the
# download from the CDS archive and for preprocessing the data with eccodes for
# WRF. Parameters for the job should be edited in the above, with directory and
