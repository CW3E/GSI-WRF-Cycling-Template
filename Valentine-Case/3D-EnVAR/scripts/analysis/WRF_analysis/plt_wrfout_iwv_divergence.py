...
h1_var_d01 = data['d01']['iwv'].flatten()
h1_var_d02 = data['d02']['iwv'].flatten()

h2_var_d01 = data_diff['d01']['iwv'].flatten()
h2_var_d02 = data_diff['d02']['iwv'].flatten()
...
plt.savefig(f_out_path + '/' + date + '_iwv_diff_plot_fzh1_' + d1 + '_fzh2_' + d2 + '.png')
plt.show()
