...
!  dfile          dtype       dplat     dsis                 dval    dthin dsfcalc
   ...
   ssmitbufr      ssmi        f13       ssmi_f13             1.0     2     0
   ssmitbufr      ssmi        f14       ssmi_f14             1.0     2     0
   ssmitbufr      ssmi        f15       ssmi_f15             1.0     2     0
   ...
   ssmisbufr      ssmis_las   f16       ssmis_f16            1.0     2     0
   ssmisbufr      ssmis_uas   f16       ssmis_f16            1.0     2     0
   ssmisbufr      ssmis_img   f16       ssmis_f16            1.0     2     0
   ssmisbufr      ssmis_env   f16       ssmis_f16            1.0     2     0
   ...
   iasibufr       iasi        metop-b   iasi616_metop-b     20.0     1     0
   gomebufr       gome        metop-b   gome_metop-b         0.0     2     0
   atmsbufr       atms        npp       atms_npp             1.0     1     0
...
::
 ...
 &HYBRID_ENSEMBLE
   ...
   n_ens=${nummem},
   beta_s0=${BETA},s_ens_h=${S_ENS_H},s_ens_v=${S_ENS_V},
